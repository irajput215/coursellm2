# dev environment outputs. These are references to resources the configuration
# would create on apply; none of them exists today. Nothing here is a claim that
...
output "nat_gateway_count" {
  description = "Number of NAT gateways. One in dev; the dominant fixed cost."
...
output "cloudfront_domain_name" {
  description = "CloudFront distribution domain name, or null because dev disables CloudFront."
